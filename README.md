## rviz_visual_tools (noetic) - 3.9.3-1

The packages in the `rviz_visual_tools` repository were released into the `noetic` distro by running `/home/tezer/.local/bin/bloom-release --rosdistro noetic --track noetic rviz_visual_tools` on `Thu, 05 Jan 2023 14:28:55 -0000`
